          ...
          item?.attributes ? (
            ...
            >
              ...
              {variant === PreviewVariant.NUMBERED && (
                <div className="text-6xl font-extrabold text-white/10 shrink-0">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm">Jonathan Stewart</span>
                </div>


                {/* Açıklama */}
                <p
                  className={`font-bold leading-snug ${variant === PreviewVariant.IMAGE_LEFT ? "text-base line-clamp-2" : "text-lg line-clamp-3"
                    }`}
                >
